...
namespace Hafen.Application.UnitTests.ShipApp.Commands.Update;

public class UpdateShipCommandHandlerTests
{

    private AbstractValidator<UpdateShipCommand> _validator = new UpdateShipCommandValidator();
    ...
    public void Ship_CreateCommand_InvalidName()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "", 1, 2, "AAAA-1111-A1");
    ...
    public void Ship_CreateCommand_InvalidLength()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "Ship Name", 0, 2, "AAAA-1111-A1");
        var validation = _validator.Validate(shipCommand);
        var errors = ConvertErrors(validation);
    ...
    public void Ship_CreateCommand_InvalidWidth()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "Ship Name", 2, 0, "AAAA-1111-A1");
        var validation = _validator.Validate(shipCommand);
        var errors = ConvertErrors(validation);
    ...
    public void Ship_CreateCommand_EmptyCode()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "Ship Name", 2, 2, "");
        var validation = _validator.Validate(shipCommand);
        var errors = ConvertErrors(validation);
    ...
    public void SShip_CreateCommand_InvalidCode()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "Ship Name", 2, 2, "AAAA-1111-AA");
        var validation = _validator.Validate(shipCommand);
        var errors = ConvertErrors(validation);
    ...
    public void Ship_CreateCommand_Valid()
    {
        ...
        var shipCommand = new UpdateShipCommand(Guid.NewGuid(), "Ship Name", 2, 2, "AAAA-1111-A1");
        var validation = _validator.Validate(shipCommand);
